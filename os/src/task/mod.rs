...
impl TaskManager {
    ...
    fn run_first_task(&self) -> ! {
        ...
        // println!("task0.last_time: {}", task0.last_time);
    ...
    fn mark_current_suspended(&self) {
        ...
        // inner.tasks[current].task_info.time += get_time_ms() - inner.tasks[current].last_time;
        // println!("inner.tasks[current].task_info.time: {}", inner.tasks[current].task_info.time);
    ...
    fn run_next_task(&self) {
        if let Some(next) = self.find_next_task() {
            ...
            // println!("inner.tasks[next].last_time: {}", inner.tasks[next].last_time);
...
/// Fetch the TaskInfo of current task.
